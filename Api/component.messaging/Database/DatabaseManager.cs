...
namespace component.messaging.Database
{
    public class DatabaseManager : IDatabaseManager
    {
        ...
        public void CompanyProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect company data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
        ...
        public void TemplateProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect template data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
        public void EntityProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect entity data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
        ...
        public void UserProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect user data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
        ...
        public void RoleProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect role data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
        ...
        public void DeviceProcessMessage(MessageModel subscribeData)
        {
            ...
            {
                _logger.Error($"Error in sync iotconnect device data : {ex.Message}, StackTrace : {ex.StackTrace}, Data : {JsonConvert.SerializeObject(subscribeData)}");
            }
        }
    }
}
