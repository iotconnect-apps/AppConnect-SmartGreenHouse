...
namespace host.iot.solution.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IUserService userService, IAdminUserService adminUserService, IConfiguration configuration)
        {
        ...
        public Entity.BaseResponse<Entity.LoginResponse> AdminLogin(Entity.LoginRequest request)
        {
            ...
            try
            {
                ...
                {
                    var secretKey = new Microsoft.IdentityModel.Tokens.SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes(_configuration.GetValue<string>("Token:SecurityKey")));
                    ...
                    var tokeOptions = new JwtSecurityToken(
                        issuer: _configuration.GetValue<string>("Token:Issuer").ToLower(),
                        audience: _configuration.GetValue<string>("Token:Audience").ToLower(),
                        claims: clm,
