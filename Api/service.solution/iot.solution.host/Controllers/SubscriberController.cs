...
namespace iot.solution.host.Controllers
{
    ...
    public class SubscriberController : BaseController
    {
        ...
        public Entity.BaseResponse<string> GetStripeKey()
        {
            ...
            try
            {
                response.Data = _configuration.GetSection("SubscriptionAPI").GetSection("StripeAPIKey").Value;
            }
            catch (Exception ex)
            {
        ...
        public BaseResponse<SubscriptionPlanResponse> GetSubscriptionPlans()
        {
            ...
            try
            {
                response.Data = _service.GetSubscriptionPlans(_configuration.GetSection("SubscriptionAPI").GetSection("SolutionCode").Value);
            }
            catch (Exception ex)
            {
        ...
        public Entity.BaseResponse<Entity.SearchResult<List<Entity.SubscriberData>>> GetBySearch(string searchText = "", int? pageNo = 1, int? pageSize = 10, string orderBy = "")
        {
            ...
            try
            {
                response.Data = _service.SubscriberList(_configuration.GetSection("SubscriptionAPI").GetSection("SolutionCode").Value
        ...
        public BaseResponse<Entity.SubsciberCompanyDetails> GetSubscriberDetails(string userEmail)
        {
            ...
            try
            {
                response.Data = _service.GetSubscriberDetails(_configuration.GetSection("SubscriptionAPI").GetSection("SolutionCode").Value, userEmail);
            }
            catch (Exception ex)
            {
