...
{
    public class GreenHouseToUpdateEntityModelMapping : ITypeConverter<Entity.GreenHouse, IOT.UpdateEntityModel>
    {
        public IOT.UpdateEntityModel Convert(Entity.GreenHouse source, IOT.UpdateEntityModel destination, ResolutionContext context)
        {
            if (source == null)
            {
                return null;
