...
namespace host.iot.solution.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            return Content(component.helper.SolutionConfiguration.Configuration.SolutionKey);
        }
            ...
            try
            {
                ...
                if (loginResult != null && loginResult.Success )
                {
                        ...
                        var tokeOptions = new JwtSecurityToken(
                            issuer: component.helper.SolutionConfiguration.Configuration.Token.Issuer,
                            audience: component.helper.SolutionConfiguration.Configuration.Token.Audience,
                            claims: clm,
