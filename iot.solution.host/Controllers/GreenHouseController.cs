...
namespace host.iot.solution.Controllers
{
    ...
    public class GreenHouseController : BaseController
    {
        ...
        [EnsureGuidParameterAttribute("id", "Greenhouse")]
        public Entity.BaseResponse<Entity.GreenHouse> Get(string id)
        {
        ...
        [ProducesResponseType(typeof(bool), (int)HttpStatusCode.OK)]
        [HttpPut]
        [Route(GreenHouseRoute.Route.DeleteImage, Name = GreenHouseRoute.Name.DeleteImage)]
        [EnsureGuidParameterAttribute("id", "Greenhouse")]
