...
export class AppConstant {
  ...
  public msgWarning = "You cannot delete this device as this device associated with child device(s).";
  public msgHKchildRequired ="Please add child device";
  public msgHKdevicedRequired ="Device not Found";
  public imgUrl = "http://192.168.6.14:8082/";
  public noImg = "../../../../assets/images/noimage.svg";
  public username = "";
  public msgHKuniqueId ="Device Unique ID already exists";
  /**
