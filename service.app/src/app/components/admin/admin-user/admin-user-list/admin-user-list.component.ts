...
export class UserAdminListComponent implements OnInit {
  ...
  /**
   * Change pagination on page change
  ...
  /**
   * Search text calll back on filter text value
   * @param filterText
   */
