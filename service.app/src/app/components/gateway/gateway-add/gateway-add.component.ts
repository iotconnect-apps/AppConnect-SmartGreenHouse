...
export class GatewayAddComponent implements OnInit {
  ...
  addgateway() {
    ...
    console.log('this.gatewayForm.status', this.gatewayForm.status);
    console.log('this.angForm.status', this.angForm.status);
    if (this.gatewayForm.status === "VALID" && this.angForm.status === "VALID") {
      this.spinner.show();
