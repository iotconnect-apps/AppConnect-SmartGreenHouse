...
002	SGH-145	05-03-2020 [Nishit Khakhi]	Updated to add commandName, description, localName and tag
003	SGH-198	24-03-2020 [Nishit Khakhi]	Updated to add isAdmin functionality
*******************************************************************/
...
BEGIN
   ...
   BEGIN TRY
		...
		SELECT   
			...
			INNER JOIN [dbo].[KitType] AS k WITH (NOLOCK) ON u.[kittypeGuid] = k.[guid] AND k.[isDeleted] = 0
