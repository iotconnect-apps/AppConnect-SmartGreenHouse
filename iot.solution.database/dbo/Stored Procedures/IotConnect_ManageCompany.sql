	...
	BEGIN TRY
		...
		BEGIN TRAN
			...
			BEGIN
				...
				INSERT INTO dbo.[Company]([guid], [cpId], [name], [greenhouseGuid], [isActive], [isDeleted],[createdDate],[createdBy],[contactNo]
			...
			BEGIN
				...
				SET  [cpId]	= CASE WHEN tc.hascpId = 1 THEN tc.cpId ELSE d.[cpId] END
					...
					,[greenhouseGuid]	= CASE WHEN tc.hasEntityguid = 1 THEN tc.entityguid ELSE d.[greenhouseGuid] END
