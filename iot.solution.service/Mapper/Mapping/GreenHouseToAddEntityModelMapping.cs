...
{
    public class GreenHouseToAddEntityModelMapping : ITypeConverter<Entity.GreenHouse, IOT.AddEntityModel>
    {
        public IOT.AddEntityModel Convert(Entity.GreenHouse source, IOT.AddEntityModel destination, ResolutionContext context)
        {
            if (source == null)
            {
                return null;
