...
namespace iot.solution.service.Data
{
    public class NotificationsService : INotificationsService
    {
        ...
        public Entity.SearchResult<List<Entity.AllRuleResponse>> List(Entity.SearchRequest request)
        {
            ...
            try
            {
                IOT.DataResponse<List<IOT.AllRuleResult>> rules = _iotConnectClient.Rule.All(new IoTConnect.Model.PagingModel() { PageNo = 1, PageSize = 1000,SearchText=request.SearchText }).Result;
